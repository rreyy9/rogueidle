...
//     version 1.13.1
//     from Assets/RogueIdle/Scripts/Player/PlayerControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/RogueIdle/Scripts/Player/PlayerControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""UIControlMapActions"",
            ""id"": ""f6dbccae-38d7-48b5-9ea4-9ebb6fae3ce4"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""4fdcc739-749c-4fb8-b2da-aead68d51a3e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""eae8f1cc-e7cf-4447-a811-76de8538d55c"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // UIControlMapActions
        m_UIControlMapActions = asset.FindActionMap("UIControlMapActions", throwIfNotFound: true);
        m_UIControlMapActions_Newaction = m_UIControlMapActions.FindAction("New action", throwIfNotFound: true);
    }
    ...
    ~@PlayerControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_UIControlMapActions.enabled, "This will cause a leak and performance issues, PlayerControls.UIControlMapActions.Disable() has not been called.");
    }
    ...
    // UIControlMapActions
    private readonly InputActionMap m_UIControlMapActions;
    private List<IUIControlMapActionsActions> m_UIControlMapActionsActionsCallbackInterfaces = new List<IUIControlMapActionsActions>();
    private readonly InputAction m_UIControlMapActions_Newaction;
    /// <summary>
    /// Provides access to input actions defined in input action map "UIControlMapActions".
    /// </summary>
    public struct UIControlMapActionsActions
    {
        private @PlayerControls m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIControlMapActionsActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "UIControlMapActions/Newaction".
        /// </summary>
        public InputAction @Newaction => m_Wrapper.m_UIControlMapActions_Newaction;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_UIControlMapActions; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="UIControlMapActionsActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(UIControlMapActionsActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="UIControlMapActionsActions" />
        public void AddCallbacks(IUIControlMapActionsActions instance)
        {
            if (instance == null || m_Wrapper.m_UIControlMapActionsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_UIControlMapActionsActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="UIControlMapActionsActions" />
        private void UnregisterCallbacks(IUIControlMapActionsActions instance)
        {
            @Newaction.started -= instance.OnNewaction;
            @Newaction.performed -= instance.OnNewaction;
            @Newaction.canceled -= instance.OnNewaction;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="UIControlMapActionsActions.UnregisterCallbacks(IUIControlMapActionsActions)" />.
        /// </summary>
        /// <seealso cref="UIControlMapActionsActions.UnregisterCallbacks(IUIControlMapActionsActions)" />
        public void RemoveCallbacks(IUIControlMapActionsActions instance)
        {
            if (m_Wrapper.m_UIControlMapActionsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="UIControlMapActionsActions.AddCallbacks(IUIControlMapActionsActions)" />
        /// <seealso cref="UIControlMapActionsActions.RemoveCallbacks(IUIControlMapActionsActions)" />
        /// <seealso cref="UIControlMapActionsActions.UnregisterCallbacks(IUIControlMapActionsActions)" />
        public void SetCallbacks(IUIControlMapActionsActions instance)
        {
            foreach (var item in m_Wrapper.m_UIControlMapActionsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_UIControlMapActionsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="UIControlMapActionsActions" /> instance referencing this action map.
    /// </summary>
    public UIControlMapActionsActions @UIControlMapActions => new UIControlMapActionsActions(this);
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "UIControlMapActions" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="UIControlMapActionsActions.AddCallbacks(IUIControlMapActionsActions)" />
    /// <seealso cref="UIControlMapActionsActions.RemoveCallbacks(IUIControlMapActionsActions)" />
    public interface IUIControlMapActionsActions
    {
        /// <summary>
