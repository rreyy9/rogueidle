...
public class PlayerController : MonoBehaviour
{
    ...
    public float rotatToTargetTime = 0.25f;
    ...
    private void HandleLateralMovement()
    {
        ...
        float clampLateralAcceleration = !isGrounded ? sprintSpeed :
                                         isWalking ? walkSpeed :
    ...
    private bool CanRun()
    {
        //This means player is moving diagonally at 45 degrees or forward, if so, run forward
